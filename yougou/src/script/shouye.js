            ...
            for (let i = 0; i < piclist.length; i++) {
                ...
                <div class="srchlst-wrap">
                  <div class="hd goods-head">
                     <a href="details.html?sid=${piclist[i].id}" target='_blank'>
                          <sup no="101086358" class="mark_small_101086358 salepic"></sup>
                          <img width="230" height="230" alt="${piclist[i].title}" class="lazy_loading lazy" data-original="${piclist[i].url}" original="//i1.ygimg.cn/pics/bata/2019/101086358/101086358_01_mb.jpg?11" />
                      </a>
                  </div>
                  <div class="bd goods-desc">
                      <span class='nptt'>
                          <a target='_blank' href='details.html' class="elli"  title="${piclist[i].title}">${piclist[i].title}</a>
                      </span>
                      ...
                      <em class="collect" id="101086358" url="details.html" src="${piclist[i].url}" price="${piclist[i].price}"></em>
                  </div>
                </div>
              </li>
            `;
